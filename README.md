...
React-based rendition of the New York Times Article Search application. App includes React components & helper/util functions, and utilizes the React mounting lifecycle to query and displays articles based on user searches. Node, Express and MongoDB were used, so that users can save articles to read later.
